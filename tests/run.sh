...
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "acceptance-scout.md"
...
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "Contract Scout Workflow"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "Scope Guard Workflow"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "Validation Coordinator Workflow"
assert_file_contains "$ROOT/prompts/playbooks/orchestration-routing.md" "validation-scheduling.md"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "Required Worker First Instruction"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "Safety Rules"
assert_file_contains "$ROOT/prompts/playbooks/orchestration-routing.md" "parallel-execution.md"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "Validation Failure Repair Workflow"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "finding-todo-loop.md"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "todo-close"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "required-path-outside-owned:"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "ownership blocker"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "Build verification failures are not eval-wrapper paperwork"
...
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "most one same-owned-path replacement"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "live worker remains no-diff after a planning checkpoint"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "active generic scout block"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "assignment-status NAME failed"
...
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "source-owner-ledger:"
assert_file_contains "$ROOT/prompts/contracts/orchestration-invariants.md" "prompts/roles/build-verifier.md"
...
assert_file_contains "$TMPDIR/orchestration-arms.out" "Multi-Agent Orchestrator"
