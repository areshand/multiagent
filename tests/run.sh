...
assert_file_contains "$ROOT/orchestrator_prompt.md" "Role Capability Catalog"
assert_file_contains "$ROOT/orchestrator_prompt.md" "orchestrator decides the DAG"
assert_file_contains "$ROOT/orchestrator_prompt.md" "supervisor enforces role isolation"
