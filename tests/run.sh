...
assert_file_contains "$ROOT/orchestrator_prompt.md" "not a source-code implementation lifecycle"
assert_file_contains "$ROOT/orchestrator_prompt.md" "actual broker or service rejection"
