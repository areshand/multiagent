...
test("session bootstrap secrets contain task data without placing it in Job arguments", () => {
  const secret = sessionSecret("task-1", "multiagent", "summarize general", "caller-123");
